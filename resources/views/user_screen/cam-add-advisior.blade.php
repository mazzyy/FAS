...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-9 mt-4 ">
            <div class="card">
                <div class="card-header"><h5><b>Upload excel file with the Advisior name and email.</b></h5></div>
        ...
        <form action="{{ route('import-advisor') }}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
